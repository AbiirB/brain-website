...
# ---------- PAGE CONFIG ----------
st.set_page_config(page_title="Brain Tumor Segmentation (2D MRI)", layout="centered")
...
st.markdown(
    ...
    ">
        <h1 style='text-align: center; color: #fff; font-size: 30px; font-weight: bold; font-family: Georgia; margin: 0;'>
            🧠 Brain Tumor Segmentation<br> 2D MRI
        </h1>
    </div>
    """,
    unsafe_allow_html=True
        ...
        if uploaded_image is None:
            ...
            try:
                ...
                if response.status_code != 200:
                    ...
                    prediction = response # response is predict_seg2D(file) >> Response(content=buffer.getvalue(), media_type="image/png")
